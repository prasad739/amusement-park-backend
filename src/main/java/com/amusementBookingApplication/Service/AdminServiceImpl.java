...
public class AdminServiceImpl implements AdminService{
	...
	@Autowired
	private LoginServiceImpl loginServ;
	
	
	
	
	@Override
	public Admin saveAdmin(LoginRequest log) throws AdminExceptions {
	...
	@Override
    public Admin updateById(updateRequestBody log, int id) {
        ...
        if(a1.isPresent()) {
            ...
            c2.setFirstName(log.getFirstName());
            c2.setLastName(log.getLastName());
            c2.setEmail(log.getEmail());
            c2.setPassword(log.getPassword());
            c2.setMobileNumber(log.getMobileNumber());
            LoginUpdate l1 = new LoginUpdate();
            l1.setUpdateId(c2.getLogin().getId());
            l1.setEmail(c2.getEmail());
            l1.setPassword(c2.getPassword());
